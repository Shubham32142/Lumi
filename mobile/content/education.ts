...
import { Activity, Apple, Brain, Footprints, Moon, Stethoscope, type LucideIcon } from 'lucide-react-native';
...
export const CATEGORIES: CategoryMeta[] = [
  { key: 'hormones', label: "What's happening", icon: Activity },
  { key: 'eat', label: 'What to eat', icon: Apple },
  { key: 'move', label: 'Movement', icon: Footprints },
  { key: 'sleep', label: 'Sleep & rest', icon: Moon },
  { key: 'emotional', label: 'Mind & mood', icon: Brain },
  { key: 'doctor', label: 'See a doctor if', icon: Stethoscope },
];
...
export const PHASE_WHY: Record<Phase, string[]> = {
  menstruation: [
    ...
    'Cramps are your uterus contracting to shed its lining. Prostaglandins are behind it.',
  ],
  follicular: [
    'Estrogen is rising again, and with it come energy, optimism, and fresh ideas.',
'Your brain is primed for learning and trying new things right now.',
  ],
  ovulation: [
    'Estrogen peaks and testosterone gives a little nudge. Confidence and social battery are full.',
'These are your most outgoing few days. Schedule the big stuff here.',
  ],
  luteal: [
 ...
 // ── Menstruation / Flow Days ──
  {
    ...
    summary: 'Both estrogen and progesterone are at their lowest, so your body is conserving energy.',
    body: [
      ...
      'This is by design, not a flaw. Think of it as your body asking for a softer pace. Rest now pays off later in the month.',
    ],
    readTimeMinutes: 1,
  },
  {
    ...
    body: [
      'Bleeding means losing iron, which can add to that tired, foggy feeling. Iron-rich foods like spinach, beans, lentils, and red meat if you eat it all help.',
      'Pair them with vitamin C from citrus, peppers, or strawberries to absorb more. Warm, cooked foods tend to feel better than cold or raw right now.',
    ],
    readTimeMinutes: 1,
  },
  {
    ...
    body: [
      "You do not have to push through. Light movement boosts circulation and can genuinely reduce cramps. Intense training may feel harder than usual, and that is normal.",
      "Try a walk, gentle yoga, or mobility work. If you feel up for more, lovely. If not, that is fine too.",
    ],
    readTimeMinutes: 1,
  },
  {
 ...
 // ── Follicular / Glow Week ──
  {
    ...
    body: [
      ...
      'This is a natural high point. Many people feel more creative and social, which makes it a good window for starting things.',
    ],
    readTimeMinutes: 1,
  },
  {
    ...
    summary: 'Strength and high-intensity workouts often feel easiest now, because your body recovers well.',
    body: [
 ...
 // ── Ovulation / Peak Days ──
  {
    ...
    summary: 'Estrogen peaks, with a testosterone bump, so confidence, libido, and charisma spike.',
    body: [
      'Around ovulation, estrogen hits its highest point and testosterone rises briefly. In short, you may feel more confident, talkative, attractive, and up for connection.',
      "It is short, usually a few days. A great window for dates, presentations, networking, or anything that needs you at your most outgoing.",
    ],
    readTimeMinutes: 1,
  },
  {
    ...
    summary: 'Fiber and antioxidants support estrogen clearing, and plenty of water helps you feel your best.',
    body: [
  ...
  },
  {
    ...
    summary: 'Communication flows easiest now, so it is a good time for the conversation you keep postponing.',
    body: [
 ...
 // ── Luteal / The Dip ──
  {
    ...
    summary: 'Progesterone rises then drops, and serotonin dips with it. That is the classic PMS setup.',
    body: [
  ...
  },
  {
    ...
    body: [
      'When serotonin drops, your brain looks for a fast mood boost, usually sugar and carbs. The spike and crash tend to make things worse.',
      "Complex carbs like oats and whole grains, magnesium from dark chocolate, nuts, and leafy greens, and protein keep blood sugar and mood steadier. You do not have to be perfect. Just aim for steady.",
    ],
    readTimeMinutes: 2,
  },
  {
  ...
  },
  {
    ...
    summary: 'The progesterone drop and a slightly higher body temperature can fragment sleep. Cool, dark, and consistent helps.',
    body: [
      ...
      'Caffeine clears slower when you are stressed, so an earlier cut-off can help the PMS-week wakefulness.',
    ],
    readTimeMinutes: 1,
  },
  {
  ...
  },
  {
    ...
    summary: 'If low mood, rage, or hopelessness each month seriously disrupts your life, that may be PMDD, and it is worth a conversation.',
    body: [
      'Most people get some PMS. But if every luteal phase brings severe depression, anxiety, anger, or hopelessness that damages your relationships, work, or safety, that pattern may be PMDD, which stands for premenstrual dysphoric disorder.',
