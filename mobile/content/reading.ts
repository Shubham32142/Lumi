  ...
  menstruation: {
    ...
    suggestions: [
      ...
      },
      {
        icon: 'eat',
        label: 'Eat',
        text: 'Top up iron: leafy greens, lentils, a little dark chocolate.',
        detail: {
          title: 'What to eat on Flow Days',
          items: [
            { name: 'Spinach & kale', note: 'iron' },
            { name: 'Lentils & beans', note: 'iron + protein' },
            { name: 'Red meat, if you eat it', note: 'iron' },
            { name: 'Dark chocolate, 70%+', note: 'iron + magnesium' },
            { name: 'Oranges, peppers, berries', note: 'vitamin C helps you absorb iron' },
            { name: 'Ginger or peppermint tea', note: 'settles cramps' },
          ],
          why: 'Bleeding loses iron, which adds to the tired, foggy feeling. Pair iron foods with vitamin C to absorb more.',
        },
      },
      {
        icon: 'move',
  ...
  follicular: {
    ...
    suggestions: [
      ...
      },
      {
        icon: 'eat',
        label: 'Eat',
        text: 'Fresh, colourful food to match the rising energy.',
        detail: {
          title: 'What to eat in Glow Week',
          items: [
            { name: 'Berries', note: 'antioxidants' },
            { name: 'Citrus & peppers', note: 'vitamin C' },
            { name: 'Leafy greens' },
            { name: 'Yogurt or kimchi', note: 'gut + hormone balance' },
            { name: 'Flax & pumpkin seeds' },
            { name: 'Lean protein', note: 'builds on the energy' },
          ],
    ...
    suggestions: [
      ...
      },
      {
        ...
        detail: {
          ...
          items: [
            { name: 'Cucumber, melon, leafy salads', note: 'light + hydrating' },
            { name: 'Berries' },
            { name: 'Whole grains & veg', note: 'fibre helps clear estrogen' },
    ...
    suggestions: [
      {
        icon: 'eat',
        label: 'Eat',
        text: 'Steady carbs and magnesium: oats, nuts, dark chocolate.',
        detail: {
          title: 'What to eat in The Dip',
          items: [
            { name: 'Oats & whole grains', note: 'steady blood sugar' },
            { name: 'Sweet potato' },
            { name: 'Dark chocolate', note: 'magnesium' },
            { name: 'Nuts & seeds', note: 'magnesium' },
            { name: 'Bananas', note: 'magnesium + B6' },
            { name: 'Leafy greens' },
          ],
